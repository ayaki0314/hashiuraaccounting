      ...
      <Card sx={{ mt: 6, p: 2 }}>
        <CardContent>
          ...
          <Typography paragraph>
            ...
            ②ユーザーのGoogleアカウントのGmailで管理者に使用開始メールを送る。<br />
            その後、管理者から当アプリ専用のスプレッドシートを受領し、自身のGoogleドライブにアップロード後に当アプリを開始できます。<br />
            管理者のメールアドレスは右記、「hashiura.public@gmail.com」<br />
          </Typography>
          ...
          <Typography paragraph>
            ・専用のスプレッドシートについて。シートの追加削除、行や列の追加削除を行わないでください。<br />
            ・一度入力されたデータは画面上から削除することができないので、スプレッドシート選択した後に出てくるリンクをタッチし、ユーザーで実際のスプレッドシートを操作し不要なデータ削除を行なってください。<br />
